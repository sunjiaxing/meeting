...
public class DragGridView extends GridView {
    ...
    public void setAdapter(ListAdapter adapter) {
        ...
        if (adapter instanceof DragGridViewAdapter) {
            dragAdater = (DragGridViewAdapter) adapter;
        } else {
            throw new IllegalStateException("adapter must implements DragGridViewAdapter ");
        }
    }
