...
public class NewsChannel {
    ...
    public static final String KEY_COLUMN_CHILD_ID = "child_id";
    public static final String KEY_COLUMN_MODEL_NAME = "model_name";
    ...
    public static final String CREAT_TABLE = "CREATE TABLE " + KEY_TABLE_NAME
            ...
            + KEY_COLUMN_TYPE_ID + " TEXT,"
            + KEY_COLUMN_NAME + " TEXT,"
            + KEY_COLUMN_CHILD_ID + " TEXT,"
            + KEY_COLUMN_MODEL_NAME + " TEXT,"
            + KEY_COLUMN_IS_LOCK + " INTEGER,"
            + KEY_COLUMN_POSITION + " INTEGER,"
            + KEY_COLUMN_IS_MINE + " INTEGER DEFAULT 0, "
