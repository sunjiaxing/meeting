...
import com.sb.meeting.ui.component.ShareDialog;
...
import com.sb.meeting.service.CommentService;
...
import com.sb.meeting.ui.fragment.CommentListFrament;
import com.sb.meeting.ui.fragment.CommentListFrament_;
import com.sb.meeting.ui.fragment.NewsDetailFragment;
import com.sb.meeting.ui.fragment.NewsDetailFragment_;
...
//                setNeedCallBack(false); 测试时注释此行代码 以便输出错误信息
    ...
    void share() {
        ...
        shareParams.setShareType(Platform.SHARE_WEBPAGE);// 仅供微信使用
        shareParams.setTitle(detailVO.getTitle());
        shareParams.setText(detailVO.getSummary());
